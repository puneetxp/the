import { registerService } from "/src/Service/Login.js";
...
<div class="my-5 d-flex justify-content-center align-items-center">
    ...
    <div class="row d-flex justify-content-center">
      <div class="col-12 col-md-8 col-lg-6">
        ...
        <div class="card bg-white shadow-lg">
          ...
          <form class="mb-3 mt-md-4"  action="/api/register" method="POST" @submit.prevent="register()">
              <h2 class="fw-bold mb-2 text-uppercase ">Register</h2>
              <p class=" mb-5">Please enter your Name, login and password!</p>
              <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input name="name" type="name" class="form-control" id="name" placeholder="Tillakaratne Dilshan">
              </div>
              <div class="mb-3">
  ...
  methods: {
    register() {
      FormFetch(event).then(r => r.json()).then(i => {
        loginState.login = i;
        this.$router.push("/");
      }).catch(i => {
